...
INPUT_PATTERNS = [
    ...
    "paper/figures/*.tex",
    "paper/scripts/*.py",
    "scripts/checks/check_paper_anonymity.py",
    "scripts/checks/check_pdf_render.py",
    "scripts/checks/check_table_figure_consistency.py",
    "scripts/reporting/write_paper_diagnostics.py",
]
