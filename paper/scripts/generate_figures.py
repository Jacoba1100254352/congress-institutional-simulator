...
def write_compromise_productivity(averages: dict[str, dict[str, float]]) -> None:
    points = [
        (CURRENT_SYSTEM_KEY, "Current", 2.8, 5.2, None),
        ("simple-majority", "SM", 4.8, -7.6, None),
        ("supermajority-60", "S60", -3.0, -6.8, "r"),
        ("bicameral-majority", "Bic", 3.2, 5.0, None),
        ("presidential-veto", "Veto", 3.6, 4.6, None),
        ("default-pass", "DP", 3.0, 4.8, None),
        ("default-pass-challenge", "Chal.", 4.4, -3.6, None),
        ("default-pass-multiround-mediation-challenge", "MedC", 3.0, -5.8, None),
        ("default-pass-constituent-citizen-panel", "Panel", -4.8, -8.8, "r"),
        ("default-pass-adaptive-track-strict", "Adapt", 2.4, 6.2, None),
        ("default-pass-alternatives-pairwise", "Pair", 2.8, -7.4, None),
        ("default-pass-affected-sponsor-gate", "Aff.", -5.2, -5.8, "r"),
        ("default-pass-public-objection", "Obj.", -3.6, 5.8, "r"),
        ("default-pass-law-registry", "Law", -4.4, -4.6, "r"),
        ("default-pass-cost-lobby-surcharge", "Cost", 3.2, -3.8, None),
        ("default-pass-deep-strategy-bundle", "Strat", -3.6, 5.4, "r"),
    ]
    left, bottom, width, height = 23.0, 14.0, 90.0, 58.0
    lines = [
        "% Auto-generated by paper/scripts/generate_figures.py",
