...
def write_design_space_coverage_table() -> None:
    rows = [
        ...
        ("Committee / agenda gate", "COMM, SCR, LOT", "Yes", "Regular order, public-interest screening, and randomized/weighted attention allocation.", "Gatekeeper capture, estimator bias, and lottery flooding."),
        ...
        ("Adaptive routing", "RISK", "Yes", "Risk-based lanes with amendment and citizen review for high-risk bills.", "Threshold gaming and classification power."),
        ...
        ("Not yet modeled", "---", "No", "Elections, courts, federalism, executive emergency power, and media ecosystems.", "Endogenous legitimacy, electoral feedback, and judicial shocks."),
    ]
    lines = [
        "% Auto-generated by paper/scripts/generate_figures.py",
        "\\begin{table*}",
