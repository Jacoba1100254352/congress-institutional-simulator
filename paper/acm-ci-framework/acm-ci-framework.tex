...
Empirical boundary checks are artifact screens, not model validation in the statistical or causal sense. \texttt{make calibrate} compares conventional baselines with broad benchmark ranges derived from Voteview, Congress.gov, govinfo, Comparative Agendas Project, lobbying-disclosure and OpenFEC records, Center for Effective Lawmaking measures, SCDB merits cases, Federal Register final-rule records, Congress.gov public-law text flags, and institutional indicators \citep{Voteview2021,CongressGovData,GovinfoBillStatus2020,ComparativeAgendasProject,SenateLDA,OpenFECData,VoldenWiseman2014,VDemDataset}. The legislative-flow layer parses every direct action in the pinned 117th-Congress govinfo H.R. and S. BILLSTATUS archives: 15,066 bills and 72,047 action records. A deterministic bill-ID split supplies 7,564 calibration bills and 7,502 held-out bills. Only the calibration half selects the current-Congress workflow's calendar-priority threshold, from a fixed 0.60--0.74 grid and 50-seed simulation panel; the held-out half is reported afterward. Calendar-threshold selection uses floor consideration and enactment, while committee advancement remains an upstream workflow check. The selected threshold, 0.68, yields committee-advance, substantive-floor, and enactment rates of 0.106, 0.061, and 0.027, compared with held-out census rates of 0.101, 0.068, and 0.025; all 50 leave-one-seed-out panels reselect 0.68. Without refitting, the complete 118th-Congress census adds 16,213 bills and 75,239 actions: committee advancement and floor consideration remain within their frozen tolerances, while the simulator overpredicts enactment by 0.010825 and misses its 0.010 tolerance by 0.000825. The temporal audit corrected a context-dependent presidential-action code without changing any 117th aggregate count. This is narrow aggregate transport evidence, not causal identification or evidence about bill quality.
...
Exact or contemporaneous bill-topic district opinion beyond the historical related-issue pilot, bill-text-specific affected-population detail, affected-group representation, lobbying sponsor/member targeting and influence, bill-linked campaign finance, direct case-to-public-law review, emergency court review, fuller implementation feedback, full statutory lineage, and observed cross-national institutional productivity or fit remain validation gaps; findings that depend on those components should be read as synthetic design hypotheses.
...
The older committee and sponsor summaries are derived from sampled Congress.gov bill actions and remain rough. The govinfo census replaces the sample as the central legislative-flow benchmark, but strict committee reporting remains descriptive because the simulator maps only the broader ordered-reported, reported, or discharged advancement union.
