...
A separate mechanism test joins the complete 116th--118th-Congress H.R. panels to the official House Rules Committee activity surveys \citep{HouseRulesSurvey116,HouseRulesSurvey117,HouseRulesSurvey118}. The source study retains 29,335 bills, 458 literal Table~1a rule grants, and four mutually exclusive observed floor routes. The plan's asserted pre-fit timing is not independently established in the repository. A post-source-audit plan fixes 1,445 threshold triples, uses the 116th--117th Congresses for development, and reserves fresh simulation seeds for an unchanged 118th-Congress test. The selected calendar, special-rule, and suspension thresholds are 0.680, 0.475, and 0.750; 16 of 20 leave-one-seed-out panels reselect that triple. Committee advancement, floor consideration, and restrictive special-rule share pass their test tolerances, but route total variation is 0.110470 against the locked 0.100 tolerance. The suspension threshold is at the grid boundary, and the simulator underproduces special-only routes and overproduces mixed and other routes. We retain the 3-of-4 gate failure without expanding the grid or retuning on the test cohort. This falsification result indicates an incomplete route mechanism and rules out interpreting the benchmark as a calibrated model of House agenda control.
...
Separate held-out and flow checks use documented empirical comparison samples for sponsors, roll calls, lobbying, campaign finance, district opinion, judicial review, implementation, statutory revision, and comparative institutions. The district-opinion path begins with a bounded Cumulative CES aggregate \citep{CumulativeCES2025}, sponsor-district bill metadata, policy-area context, Census/ACS district context, and a 22-bill review queue. An official bill-text review retains one directionally related historical policy-preference item for H.R. 8404 and preserves 21 negative dispositions against forced policy-area matches. That retained item is joined to pinned 2012 and 2016 CCES Common Content geography and validated-voter weights \citep{CumulativeCESPolicyPreferences2023,CCESCommon2012,CCESCommon2016}, producing two privacy-thresholded NY-10 direct-weighted aggregates with 372 published responses. The item does not use the bill wording, both estimates predate enactment, and the layer supplies neither design-based uncertainty, MRP, affected-group evidence, causal representation, nor model validation. Across all source families, 14 targeted held-out checks pass broad prespecified ranges; the linkage audit reports all fourteen source families as linked, metadata-linked, or partially linked. Passing these screens is minimum plausibility evidence only.

A post-fit House source audit finds one Senate action misattributed as House suspension evidence. A direct-action-only screen increases fixed-model route variation to 0.111950; the original fit and failed gate remain unchanged. Retained House Clerk and resolution records establish a separate indirect suspension path through H. Res. 1061 for that bill \citep{HouseRollCall2024064,HouseResolution1061EH}. The screen is not a complete route correction. History-wide source routes and the model's single-decision score overlap are not equivalent procedural sequences.

The fitted special-rule and suspension thresholds assign diagnostic labels to admitted bills; they do not alter the inner voting threshold or amendment rights. Matching these labels would not establish implementation of actual House procedures.
