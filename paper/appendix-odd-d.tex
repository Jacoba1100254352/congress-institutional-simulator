...
The main campaigns are v17 broad roadmap completion, v18 party-system sensitivity, v19 rising-contention timeline, and v20 focused strategy/calibration comparison. The v20 campaign includes the current-system benchmark, conventional affirmative baselines, default enactment, budgeted lobbying, strategic lobbying, adaptive proposers, adaptive proposers with strategic lobbying, a combined deep-strategy bundle, multi-round mediation, citizen panels, alternatives, public objection, and law-registry review.
...
Run tests with \texttt{make test}. Run the current campaign with \texttt{make campaign}. Run empirical benchmark screening with \texttt{make calibrate}. Build the paper and appendix PDFs with \texttt{make paper}. All generated campaign reports and PDFs are tracked in the public repository.
