...
\begin{itemize}
  ...
  \item \texttt{make validation-readiness}, \texttt{make empirical-validation}, and \texttt{make empirical-bridge}: check optional raw inputs, summarize any present data, and map summaries to simulator proxies. Adapter fixtures live separately and do not count as raw validation data.
