...
| `reports/adversarial-pilot-cell-map.md` | Maps aggregate pilot cells and executable A1-A8 artifacts to the adversary catalog. | It is a readiness map rather than result evidence; A9 remains without an executable artifact. |
| A1-A8 adversarial summaries and trace JSONL artifacts under `reports/` | First executable A1 clone/decoy through A8 public-support-distortion pilots have budget/information cells, success rates, median/worst degradation, and same-generated-world trace rows. A7 additionally reports queue saturation and no-case recovery cycles; A8 compares signal-reliant and constituent-verified paths and reports same-case signal correction. | The pilots cover bounded mechanism paths; A9, broad mechanism coverage, multi-seed sensitivity, temporal or substantive correction beyond bounded A7/A8 evidence, and externally validated attack rates remain missing. |
