...
The current pipeline has a registry-backed benchmark v1, nine narrow held-out source-family checks, and 14 / 14 source families classified as linked, metadata-linked, or partially linked. The fully linked House agenda-control family contributes 29,335 source-pinned H.R. lifecycle rows, 458 literal Table 1a grant rows, four observed floor-route classes, and 469 denominator-explicit descriptive metrics. A separately locked simulator study retains all 1,445 candidates and fails its unchanged 118th-Congress route-composition gate while passing the other three gates. The other bounded evidence includes GovInfo lifecycle and executive panels, Voteview roll-call and member context, sponsor-bill metadata, district-opinion policy context, OpenFEC issue and candidate context, SCDB/Federal Register authority overlaps, rulemaking histories and comment metadata, statutory-lineage review packets, and comparative scenario-family anchors. The roadmap retains upgrade gates for nine non-fully-linked families.

A full paper should still wait for stronger direct linkage and mechanism tests. The largest gaps are exact or contemporaneous bill-topic public opinion, complete sponsor histories, bill-specific finance and lobbying targets and outcomes, direct case-to-statute court review, complete statutory lineage, implementation outcomes, observed comparative law output, and a richer House route mechanism supported by referral-jurisdiction and status-quo-fallback evidence. The current House source study is descriptive, and the locked simulator test is falsification evidence rather than simulator validation or causal agenda-control evidence.

The legislative-flow source family has complete pinned 116th-, 117th-, and 118th-Congress H.R./S. censuses and two external-Congress no-refit transport tests. Five of six aggregate cohort-metric cells transport within prespecified tolerances; 118th-Congress enactment misses by 0.000825. Separate source-pinned decision panels contain 4,021 H.R./S. and 187 joint-resolution presentments. Their combined empirical conditional veto rate is 0.011169 versus 0.246852 in the selected simulator panel, a 22.101-fold difference. A study locked after source audit but before fitting trains through the 117th Congress and tests all 287 118th-Congress presentments. Its fixed support model lowers log loss from 0.223369 to 0.026977 and meets the fixed aggregate-calibration tolerance; the secondary 116th check also improves log loss. This does not change the full-paper no-go: 12 of 13 primary test vetoes occur among only 17 joint resolutions, the lifecycle tests cover three aggregate flow rates and one stylized workflow, and the simulator's veto rate remains an elevated-propensity stress mechanism rather than a U.S.-calibrated model.
...
- `reports/presidential-choice-study.md`: locked low-event temporal prediction study with machine-readable metrics, coefficients, row-level predictions, hashes, and a post-fit concentration audit.
...
make presidential-choice-study-check
