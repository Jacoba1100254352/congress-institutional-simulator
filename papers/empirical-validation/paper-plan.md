...
The legislative-flow source family now also has complete pinned 116th-, 117th-, and 118th-Congress H.R./S. censuses and two external-Congress no-refit transport tests. Five of six aggregate cohort-metric cells transport within prespecified tolerances; 118th-Congress enactment misses by 0.000825. A separate diagnostic finds a pooled empirical conditional veto rate of 0.003119 versus 0.246852 in the selected simulator panel, a 79.157-fold difference. This expands temporal-flow evidence but does not change the full-paper no-go: the tests cover three aggregate flow rates and one stylized workflow, while the veto result identifies the executive-choice mechanism as an elevated-propensity stress mechanism rather than a U.S.-calibrated model.
