...
The district public-opinion path also now has official Cumulative CES Policy Preferences candidate-item metadata, raw response-code distributions, and guide codebook item-direction labels for queued public-law packets: 18 / 22 packet rows map to 43 exact source variable IDs across 11 policy areas, with unweighted raw response-code distributions attached across 16 source years and guide labels attached for those candidate variables. Exact bill-topic support estimates, bill-text direction-alignment rows, and MRP/small-area estimates remain at 0. Treat this as source-review scaffolding for future public-opinion acquisition, not as public-support validation.
...
- `data/validation/raw/`: current raw empirical summaries and auxiliary linkage caches, including the govinfo BILLSTATUS cross-check, sponsor-bill metadata linkage, OpenFEC campaign-finance extract, FEC recipient-metadata linkage, Cumulative CES district-opinion aggregate, district public-opinion policy-context cache, district public-opinion CES policy-preference candidate-item cache, district public-opinion CES policy-preference raw response-code distribution cache, district public-opinion CES policy-preference codebook-direction cache, SCDB court-review extract, SCDB/Federal Register court-law U.S.C.-section overlap cache, Federal Register final-rule effective-date extract, Federal Register authority-search cache, Federal Register proposed-history cache, Regulations.gov comment-record metadata cache, Congress.gov law-revision text extract, and Congress.gov public-law bill/action linkage.
...
1. Upgrade the bounded public-opinion proxy beyond sponsor-district bill policy-area context, candidate-item metadata, raw response-code distributions, and codebook item-direction labels with bill-text direction alignment, bill-topic mapping, and MRP/small-area estimates where appropriate; add full statutory lineage beyond the current law-revision text proxy, bill/action metadata, authority/proposed-history/comment-portal/comment-record metadata, timing metadata, and court U.S.C.-section overlap; add direct and emergency-order court review, implementation-feedback sources beyond final-rule effective dates, bounded complete, zero-comment, and partial comment-record metadata, and timing metadata, and campaign-finance linkage beyond FEC recipient metadata, bounded issue-sector context, matched member context, bounded House-candidate district context, and bounded candidate-to-sponsored-bill context to reviewed outside-spending targets, committee-action influence, and outcomes, or explicitly justify replacements.
