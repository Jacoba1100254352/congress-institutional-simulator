...
The legislative-flow source family has complete pinned 116th-, 117th-, and 118th-Congress H.R./S. censuses and two external-Congress no-refit transport tests. Five of six aggregate cohort-metric cells transport within prespecified tolerances; 118th-Congress enactment misses by 0.000825. A separate compact 108th-118th-Congress panel finds a pooled empirical conditional veto rate of 0.005223 versus 0.246852 in the selected simulator panel, a 47.266-fold difference. This expands temporal and executive coverage but does not change the full-paper no-go: the lifecycle tests cover three aggregate flow rates and one stylized workflow, while the veto result identifies the executive-choice mechanism as an elevated-propensity stress mechanism rather than a U.S.-calibrated model.
