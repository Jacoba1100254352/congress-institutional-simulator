...
| C8 | Public-support representation can be evaluated empirically with current data. | Current simulator reports synthetic public support and enacted support; a bounded CES district aggregate exists as a weak proxy. | Bill-topic district opinion, MRP/small-area estimates, and affected-group support/harm data are missing. | CCES/CES/MRP, ACS, affected-population mapping. | Not supported beyond proxy boundary. |
