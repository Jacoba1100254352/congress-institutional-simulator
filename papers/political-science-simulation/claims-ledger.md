...
| C9 | Current results support empirical validation of welfare, public support, harm, capture, or correction. | No sufficient support. | Current empirical checks now include nine narrow held-out source-family screens, a linkage audit, and a linkage roadmap; 13 / 13 source families are linked, metadata-linked, or partially linked, but the remaining gates remain proxy and boundary checks rather than validation of welfare, public support, harm, capture, correction, or comparative institutional fit. | Linked validation workflow with bill-topic, complete sponsor-history, finance, implementation, direct court, statutory-lineage, and observed comparative output data. | Exclude. |
