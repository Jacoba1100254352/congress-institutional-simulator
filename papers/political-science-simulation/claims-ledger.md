...
| C2 | The stylized U.S.-like benchmark is useful as a synthetic comparison baseline. | `current-system` rows in `reports/simulation-campaign-v21-paper.csv`; `reports/calibration-baseline.md`; complete 117th/118th GovInfo censuses; `reports/legislative-lifecycle-temporal-replication.md`. | It is not a calibrated Congress model. Its frozen aggregate flow test passes committee advancement and floor consideration but overpredicts 118th-Congress enactment beyond the prespecified tolerance. | A third completed Congress plus source-specific referral, calendar, veto, and status-quo-fallback data. | Supported with caveat. |
...
| C9 | Current results support empirical validation of welfare, public support, harm, capture, or correction. | No sufficient support. | Current empirical checks include nine narrow held-out source-family screens, a complete-Congress no-refit flow test, a linkage audit, and a linkage roadmap; 13 / 13 source families are linked, metadata-linked, or partially linked, but the remaining gates are proxy and boundary checks rather than validation of welfare, public support, harm, capture, correction, or comparative institutional fit. | Linked validation workflow with bill-topic, complete sponsor-history, finance, implementation, direct court, statutory-lineage, and observed comparative output data. | Exclude. |
