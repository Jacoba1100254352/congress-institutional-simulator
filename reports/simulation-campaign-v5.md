...
| Default pass + member challenge vouchers t=1 s=.82 | 0.351 | 43.368 | 97.500 | 0.555 | 0.168 | 0.176 | 0.365 | 0.781 | 1.000 |
| Default pass + member challenge vouchers t=2 s=.82 | 0.279 | 28.510 | 97.500 | 0.577 | 0.104 | 0.110 | 0.308 | 0.870 | 1.000 |
| Default pass + member challenge vouchers t=3 s=.82 | 0.269 | 25.453 | 97.500 | 0.582 | 0.086 | 0.102 | 0.301 | 0.886 | 1.000 |
| Default pass + party challenge vouchers t=10 s=.50 | 0.654 | 72.259 | 97.500 | 0.476 | 0.397 | 0.469 | 0.578 | 0.423 | 1.000 |
| Default pass + party challenge vouchers t=10 s=.65 | 0.649 | 71.945 | 97.500 | 0.478 | 0.397 | 0.460 | 0.570 | 0.422 | 1.000 |
| Default pass + party challenge vouchers t=10 s=1.00 | 0.643 | 71.493 | 97.500 | 0.482 | 0.401 | 0.441 | 0.549 | 0.420 | 1.000 |
| Default pass + party challenge vouchers t=10 s=1.25 | 0.643 | 71.490 | 97.500 | 0.484 | 0.406 | 0.431 | 0.536 | 0.416 | 1.000 |
| Default pass + party challenge vouchers t=15 s=.82 | 0.493 | 60.274 | 97.500 | 0.516 | 0.306 | 0.306 | 0.471 | 0.603 | 1.000 |
| Default pass + party challenge vouchers t=25 s=.82 | 0.386 | 49.346 | 97.500 | 0.549 | 0.191 | 0.210 | 0.389 | 0.745 | 1.000 |
| Default pass + party challenge vouchers t=3 s=.82 | 0.893 | 89.690 | 97.500 | 0.451 | 0.475 | 0.689 | 0.634 | 0.127 | 1.000 |
| Default pass + party challenge vouchers t=6 s=.82 | 0.785 | 81.892 | 97.500 | 0.460 | 0.452 | 0.586 | 0.610 | 0.254 | 1.000 |
...
| Default pass + q=12 challenge escalation s=.82 | 0.272 | 25.620 | 97.500 | 0.580 | 0.102 | 0.101 | 0.297 | 0.875 | 1.000 |
| Default pass + q=20 challenge escalation s=.82 | 0.275 | 25.844 | 97.500 | 0.577 | 0.107 | 0.102 | 0.295 | 0.867 | 1.000 |
| Default pass + q=6 challenge escalation s=.82 | 0.270 | 25.446 | 97.500 | 0.580 | 0.091 | 0.101 | 0.298 | 0.884 | 1.000 |
...
| Default pass + party challenge vouchers t=3 s=.82 | 0.052 | 0.019 | 0.001 | -0.052 | 0.127 |
| Default pass + party challenge vouchers t=6 s=.82 | -0.055 | -0.004 | -0.102 | -0.076 | 0.254 |
| Default pass + party challenge vouchers t=15 s=.82 | -0.347 | -0.150 | -0.383 | -0.215 | 0.603 |
| Default pass + party challenge vouchers t=25 s=.82 | -0.454 | -0.264 | -0.479 | -0.298 | 0.745 |
| Default pass + party challenge vouchers t=10 s=.50 | -0.187 | -0.058 | -0.220 | -0.108 | 0.423 |
| Default pass + party challenge vouchers t=10 s=.65 | -0.191 | -0.058 | -0.228 | -0.116 | 0.422 |
| Default pass + party challenge vouchers t=10 s=1.00 | -0.197 | -0.054 | -0.247 | -0.137 | 0.420 |
| Default pass + party challenge vouchers t=10 s=1.25 | -0.197 | -0.049 | -0.257 | -0.150 | 0.416 |
| Default pass + member challenge vouchers t=1 s=.82 | -0.489 | -0.287 | -0.512 | -0.321 | 0.781 |
| Default pass + member challenge vouchers t=2 s=.82 | -0.561 | -0.351 | -0.578 | -0.379 | 0.870 |
| Default pass + member challenge vouchers t=3 s=.82 | -0.571 | -0.370 | -0.586 | -0.385 | 0.886 |
| Default pass + q=6 challenge escalation s=.82 | -0.570 | -0.364 | -0.587 | -0.388 | 0.884 |
| Default pass + q=12 challenge escalation s=.82 | -0.568 | -0.353 | -0.587 | -0.389 | 0.875 |
| Default pass + q=20 challenge escalation s=.82 | -0.565 | -0.348 | -0.586 | -0.391 | 0.867 |
...
| --- | --- | --- | --- |
| Baseline | Default pass + strong cross-bloc cosponsors (0.728) | Default pass + party challenge vouchers t=3 s=.82 (0.871) | Unicameral simple majority (0.000) |
| Low Polarization | Default pass + strong cross-bloc cosponsors (0.671) | Default pass + party challenge vouchers t=3 s=.82 (0.890) | Unicameral simple majority (0.000) |
| High Polarization | Default pass + strong cross-bloc cosponsors (0.785) | Default pass + party challenge vouchers t=3 s=.82 (0.864) | Unicameral simple majority (0.000) |
| Low Party Loyalty | Default pass + strong cross-bloc cosponsors (0.718) | Default pass + party challenge vouchers t=3 s=.82 (0.875) | Unicameral simple majority (0.000) |
| High Party Loyalty | Default pass + strong cross-bloc cosponsors (0.716) | Default pass + party challenge vouchers t=3 s=.82 (0.874) | Unicameral simple majority (0.000) |
| Low Compromise Culture | Default pass + strong cross-bloc cosponsors (0.771) | Default pass + party challenge vouchers t=3 s=.82 (0.867) | Unicameral simple majority (0.000) |
| High Compromise Culture | Default pass + strong cross-bloc cosponsors (0.685) | Default pass + party challenge vouchers t=3 s=.82 (0.879) | Unicameral simple majority (0.000) |
...
| High Lobbying Pressure | Default pass + strong cross-bloc cosponsors (0.743) | Default pass + party challenge vouchers t=3 s=.82 (0.870) | Unicameral simple majority (0.000) |
...
| Two-Party System | Default pass + strong cross-bloc cosponsors (0.764) | Default pass + party challenge vouchers t=3 s=.82 (0.917) | Unicameral simple majority (0.000) |
...
| Low-Compromise Flooding | Default pass + strong cross-bloc cosponsors (0.808) | Default pass + party challenge vouchers t=3 s=.82 (0.954) | Unicameral simple majority (0.000) |
...
- The next model extension should add sunset trial legislation, because the remaining risk is bad-law persistence after enactment.
