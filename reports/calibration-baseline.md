...
- bills per run: 60
- seed: 20260428
- scenarios: simple-majority, bicameral-majority, presidential-veto, current-system, current-congress-workflow, default-pass-budgeted-lobbying, district-population-majority, influence-system-majority, constitutional-court-architecture-majority, law-registry-majority
...
| --- | --- | --- | ---: | ---: | --- |
| current-congress-committee-advance-rate | current-congress-workflow | committeeAdvanceRate | 0.079--0.120 | 0.108 | yes |
| current-congress-floor-consideration-rate | current-congress-workflow | floor | 0.050--0.081 | 0.060 | yes |
| current-congress-enactment-rate | current-congress-workflow | productivity | 0.012--0.033 | 0.025 | yes |
...
| district-public-will-alignment | district-population-majority | districtAlignment | 0.200--0.800 | 0.394 | yes |
...
| implementation-delay-proxy | law-registry-majority | implementationDelay | 0.000--100.000 | 0.505 | yes |
| implementation-capacity-proxy | law-registry-majority | implementationCapacity | 0.000--1.000 | 0.174 | yes |
| law-revision-correction-proxy | law-registry-majority | reversalRate | 0.000--0.800 | 0.469 | yes |
| bicameral-veto-burden | bicameral-majority | interChamberConflictRate | 0.050--0.600 | 0.148 | yes |

## Sources

- current-congress-committee-advance-rate: GovInfo BILLSTATUS 117th-Congress H.R. and S. census. Range centered on the deterministic calibration split with a 0.020 abstraction tolerance; held-out rows were not used to select the threshold
