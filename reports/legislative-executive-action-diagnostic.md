...
The separately locked presidential-choice study now trains on 3,921 measures through the 117th Congress and tests all 287 118th-Congress presentments. Its fixed support model has log loss 0.026977 versus 0.223369 for the training-prevalence baseline and calibration-in-the-large 0.003149, passing the two-part gate. This result does not retroactively convert the descriptive strata above into causal effects or validate the simulator's veto mechanism; 12 of 13 test vetoes arise among only 17 joint resolutions. The next gate is an unchanged future whole-Congress replication with measure-class-specific reporting. The current flow threshold and transport tolerances remain frozen.
