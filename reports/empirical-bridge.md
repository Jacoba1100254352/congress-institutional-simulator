...
| District public will | `district_public_opinion.csv` / intensityWeightedSupport = --- (missing) | --- | --- | --- | missing flow-check proxy |
| District turnout skew | `district_public_opinion.csv` / turnoutGini = --- (missing) | --- | --- | --- | missing flow-check proxy |
...
| Court emergency posture | `court_review.csv` / emergencyOrderRate = --- (missing) | --- | --- | --- | missing flow-check proxy |
| Court invalidation | `court_review.csv` / invalidationRate = --- (missing) | --- | --- | --- | missing flow-check proxy |
| Comparative bicameralism | `comparative_institutions.csv` / bicameralShare = --- (missing) | --- | --- | --- | missing flow-check proxy |
