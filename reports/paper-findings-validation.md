...
- Top revision-moderation scores under party-system sensitivity cases: `simple-majority-alternatives-pairwise` (0.518), `pairwise-amendment-tournament-majority` (0.517), `expanded-portfolio-hybrid-legislature` (0.464), `portfolio-hybrid-legislature` (0.410), `current-system` (0.377).
...
- Versus pairwise alternatives, `portfolio-hybrid-legislature` changes productivity by -0.025, revision moderation by -0.079, risk control by -0.005, low-public-support enactment by +0.026, and lobbying capture by -0.081.
- Versus risk-routed majority, `portfolio-hybrid-legislature` changes productivity by -0.020, revision moderation by +0.164, risk control by +0.093, low-public-support enactment by -0.202, and lobbying capture by -0.138.
- Versus anti-capture bundle, `portfolio-hybrid-legislature` changes productivity by +0.215, revision moderation by +0.182, risk control by +0.050, low-public-support enactment by -0.124, and lobbying capture by +0.012.
- Versus open default pass, `portfolio-hybrid-legislature` changes productivity by -0.341, revision moderation by +0.290, risk control by +0.301, low-public-support enactment by -0.443, and lobbying capture by -0.127.
