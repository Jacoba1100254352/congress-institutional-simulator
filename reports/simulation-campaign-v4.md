...
| Default pass + member challenge vouchers t=1 s=.82 | 0.351 | 43.373 | 97.500 | 0.556 | 0.169 | 0.175 | 0.362 | 0.781 | 1.000 |
| Default pass + member challenge vouchers t=2 s=.82 | 0.280 | 28.596 | 97.500 | 0.577 | 0.104 | 0.111 | 0.310 | 0.870 | 1.000 |
| Default pass + member challenge vouchers t=3 s=.82 | 0.268 | 25.350 | 97.500 | 0.582 | 0.088 | 0.101 | 0.299 | 0.886 | 1.000 |
| Default pass + party challenge vouchers t=10 s=.50 | 0.653 | 72.217 | 97.500 | 0.476 | 0.398 | 0.468 | 0.578 | 0.423 | 1.000 |
| Default pass + party challenge vouchers t=10 s=.65 | 0.649 | 71.917 | 97.500 | 0.479 | 0.397 | 0.460 | 0.569 | 0.422 | 1.000 |
| Default pass + party challenge vouchers t=10 s=1.00 | 0.643 | 71.533 | 97.500 | 0.482 | 0.400 | 0.442 | 0.550 | 0.420 | 1.000 |
| Default pass + party challenge vouchers t=10 s=1.25 | 0.644 | 71.543 | 97.500 | 0.484 | 0.405 | 0.432 | 0.537 | 0.416 | 1.000 |
| Default pass + party challenge vouchers t=15 s=.82 | 0.493 | 60.243 | 97.500 | 0.516 | 0.305 | 0.305 | 0.470 | 0.603 | 1.000 |
| Default pass + party challenge vouchers t=25 s=.82 | 0.386 | 49.322 | 97.500 | 0.549 | 0.194 | 0.209 | 0.388 | 0.746 | 1.000 |
| Default pass + party challenge vouchers t=3 s=.82 | 0.893 | 89.700 | 97.500 | 0.451 | 0.474 | 0.690 | 0.634 | 0.127 | 1.000 |
| Default pass + party challenge vouchers t=6 s=.82 | 0.786 | 81.936 | 97.500 | 0.460 | 0.449 | 0.587 | 0.611 | 0.254 | 1.000 |
...
| Default pass + q=12 challenge escalation s=.82 | 0.273 | 25.693 | 97.500 | 0.579 | 0.098 | 0.102 | 0.298 | 0.876 | 1.000 |
| Default pass + q=20 challenge escalation s=.82 | 0.276 | 25.943 | 97.500 | 0.577 | 0.107 | 0.102 | 0.295 | 0.866 | 1.000 |
| Default pass + q=6 challenge escalation s=.82 | 0.269 | 25.316 | 97.500 | 0.581 | 0.092 | 0.100 | 0.296 | 0.884 | 1.000 |
...
| Default pass + party challenge vouchers t=6 s=.82 | -0.054 | -0.006 | -0.101 | -0.075 | 0.254 |
| Default pass + party challenge vouchers t=15 s=.82 | -0.348 | -0.150 | -0.384 | -0.216 | 0.603 |
| Default pass + party challenge vouchers t=25 s=.82 | -0.454 | -0.261 | -0.479 | -0.298 | 0.746 |
| Default pass + party challenge vouchers t=10 s=.50 | -0.187 | -0.057 | -0.220 | -0.108 | 0.423 |
| Default pass + party challenge vouchers t=10 s=.65 | -0.192 | -0.058 | -0.229 | -0.117 | 0.422 |
| Default pass + party challenge vouchers t=10 s=1.00 | -0.197 | -0.056 | -0.246 | -0.136 | 0.420 |
| Default pass + party challenge vouchers t=10 s=1.25 | -0.196 | -0.050 | -0.256 | -0.150 | 0.416 |
| Default pass + member challenge vouchers t=1 s=.82 | -0.489 | -0.286 | -0.513 | -0.324 | 0.781 |
| Default pass + member challenge vouchers t=2 s=.82 | -0.560 | -0.351 | -0.577 | -0.377 | 0.870 |
| Default pass + member challenge vouchers t=3 s=.82 | -0.572 | -0.367 | -0.587 | -0.387 | 0.886 |
| Default pass + q=6 challenge escalation s=.82 | -0.571 | -0.363 | -0.588 | -0.390 | 0.884 |
| Default pass + q=12 challenge escalation s=.82 | -0.567 | -0.357 | -0.586 | -0.388 | 0.876 |
| Default pass + q=20 challenge escalation s=.82 | -0.565 | -0.348 | -0.586 | -0.391 | 0.866 |
...
| Low Polarization | Default pass + strong cross-bloc cosponsors (0.671) | Default pass + party challenge vouchers t=3 s=.82 (0.891) | Unicameral simple majority (0.000) |
...
| High Party Loyalty | Default pass + strong cross-bloc cosponsors (0.716) | Default pass + party challenge vouchers t=3 s=.82 (0.872) | Unicameral simple majority (0.000) |
...
| Weak Constituency Pressure | Default pass + strong cross-bloc cosponsors (0.811) | Default pass + party challenge vouchers t=3 s=.82 (0.868) | Unicameral simple majority (0.000) |
...
- The next model extension should add adaptive procedural tracks, because the agenda system now needs to route bills by risk rather than screening every bill with one rule.
