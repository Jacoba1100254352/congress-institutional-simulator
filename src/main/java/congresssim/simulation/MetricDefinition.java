...
)
{
	private static final List<MetricDefinition> DEFINITIONS = List.of(
			...
			new MetricDefinition("closedRuleRate", "Closed rule rate", MetricDirection.DIAGNOSTIC, "Share of bills routed through a closed-rule floor path."),
			new MetricDefinition("openRuleRate", "Open rule rate", MetricDirection.DIAGNOSTIC, "Share of bills routed through an open-rule floor path."),
