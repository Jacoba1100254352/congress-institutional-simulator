...
)
{
	private static final List<MetricDefinition> DEFINITIONS = List.of(
			...
			new MetricDefinition("compromise", "Revision moderation", MetricDirection.HIGHER_IS_BETTER, "Moderation, support, and distance from proposer advantage."),
			...
			new MetricDefinition("enactedPolicyQuality", "Enacted-policy quality", MetricDirection.HIGHER_IS_BETTER, "Quality among enacted bills, separated from the share of bills blocked before enactment."),
			new MetricDefinition("policyYield", "Policy yield", MetricDirection.HIGHER_IS_BETTER, "Public-benefit yield over all submitted proposals, not only enacted bills."),
				new MetricDefinition("publicMandateLegitimacy", "Public support", MetricDirection.HIGHER_IS_BETTER, "Support, alignment, legitimacy, and avoidance of low-public-support enactments."),
			...
			new MetricDefinition("lowSupport", "Low-support passage", MetricDirection.LOWER_IS_BETTER, "Enacted bills with less than majority yes support."),
				new MetricDefinition("weakPublicMandatePassage", "Low-public-support enactment", MetricDirection.LOWER_IS_BETTER, "Enacted bills with generated public support below majority."),
			...
			new MetricDefinition("lowSupportActiveLawShare", "Low-support active-law share", MetricDirection.LOWER_IS_BETTER, "Persistent enacted law stock with weak support."),
				new MetricDefinition("falseNegativePassRate", "False-negative burden-shift passage", MetricDirection.LOWER_IS_BETTER, "Risky burden-shifting enactments that passed unchallenged."),
			...
			new MetricDefinition("blockageReliance", "Blockage reliance", MetricDirection.LOWER_IS_BETTER, "How much a system's apparent quality comes from pre-floor blockage rather than policy production."),
			...
			new MetricDefinition("multidimensionalCompromiseGain", "Multidimensional revision gain", MetricDirection.HIGHER_IS_BETTER, "Support gain from package bargaining."),
			...
			new MetricDefinition("citizenAgendaPetitionRate", "Citizen agenda petition", MetricDirection.DIAGNOSTIC, "Share of bills routed through a citizen agenda petition bypass."),
				new MetricDefinition("petitionMandateStrength", "Petition support strength", MetricDirection.HIGHER_IS_BETTER, "Public-support signal strength among petition-routed bills."),
			new MetricDefinition("petitionCaptureDistortion", "Petition capture distortion", MetricDirection.LOWER_IS_BETTER, "Capture or campaign-pressure distortion in petition routing."),
			new MetricDefinition("costlyPublicMandateSignal", "Costly public signal", MetricDirection.HIGHER_IS_BETTER, "Public pressure rooted in salience, affectedness, and persistent participation rather than cheap volume."),
			new MetricDefinition("cheapSignalDistortion", "Cheap signal distortion", MetricDirection.LOWER_IS_BETTER, "Lobby-amplified or campaign-amplified public pressure that can mimic broad mandate."),
			new MetricDefinition("publicMandateIntensity", "Public mandate intensity", MetricDirection.DIAGNOSTIC, "Combined salience and mandate strength of a petition signal."),
			new MetricDefinition("openCalendarRate", "Open floor calendar", MetricDirection.DIAGNOSTIC, "Share of bills admitted by default-open floor calendar rules."),
			new MetricDefinition("calendarDelayCost", "Calendar delay cost", MetricDirection.LOWER_IS_BETTER, "Estimated calendar delay cost under open-floor routing."),
			new MetricDefinition("amendmentOpenness", "Amendment openness", MetricDirection.HIGHER_IS_BETTER, "How open the floor path is to amendment before final passage."),
			new MetricDefinition("floorSchedulingDelay", "Floor scheduling delay", MetricDirection.LOWER_IS_BETTER, "Estimated delay from floor-calendar and rule-setting control."),
			new MetricDefinition("closedRuleRate", "Restrictive rule pressure", MetricDirection.DIAGNOSTIC, "Share of submitted bills reaching the scheduling layer with restrictive rule pressure before floor admission."),
			new MetricDefinition("openRuleRate", "Open rule pressure", MetricDirection.DIAGNOSTIC, "Share of submitted bills reaching the scheduling layer without restrictive rule pressure before floor admission."),
			new MetricDefinition("specialRuleRouteScore", "Special-rule route score", MetricDirection.DIAGNOSTIC, "Generated pressure for an adopted-special-rule floor route."),
			new MetricDefinition("suspensionRouteScore", "Suspension route score", MetricDirection.DIAGNOSTIC, "Generated eligibility for a suspension-like floor route."),
			new MetricDefinition("specialRuleOnlyRouteRate", "Special-rule-only route", MetricDirection.DIAGNOSTIC, "Share of submitted bills admitted through the modeled special-rule-only route."),
			new MetricDefinition("suspensionOnlyRouteRate", "Suspension-only route", MetricDirection.DIAGNOSTIC, "Share of submitted bills admitted through the modeled suspension-only route."),
			new MetricDefinition("mixedSpecialRuleAndSuspensionRouteRate", "Mixed special-rule and suspension route", MetricDirection.DIAGNOSTIC, "Share of submitted bills meeting both modeled route conditions."),
			new MetricDefinition("otherFloorRouteRate", "Other floor route", MetricDirection.DIAGNOSTIC, "Share of submitted bills admitted without either modeled special-rule or suspension condition."),
			new MetricDefinition("restrictiveSpecialRuleRouteRate", "Restrictive special-rule route", MetricDirection.DIAGNOSTIC, "Share of submitted bills assigned a modeled special-rule route with restrictive rule pressure."),
			new MetricDefinition("floorRouteAssignmentRate", "Assigned floor route", MetricDirection.DIAGNOSTIC, "Share of submitted bills admitted to the floor and assigned exactly one modeled route."),
			new MetricDefinition("dischargeBackstopUse", "Discharge backstop use", MetricDirection.DIAGNOSTIC, "Share of bills where public mandate or cosponsor pressure bypasses restrictive scheduling."),
			new MetricDefinition("statusQuoFallbackPressure", "Status-quo fallback pressure", MetricDirection.LOWER_IS_BETTER, "Pressure for floor scheduling to preserve the status quo by delay or denial."),
			new MetricDefinition("leadershipSchedulingBias", "Leadership scheduling bias", MetricDirection.LOWER_IS_BETTER, "Estimated leadership-driven floor scheduling skew."),
			new MetricDefinition("rulesCommitteeCaptureIndex", "Rules capture index", MetricDirection.LOWER_IS_BETTER, "Capture risk in floor-rule and scheduling control."),
			new MetricDefinition("amendmentOverload", "Amendment overload", MetricDirection.LOWER_IS_BETTER, "Amendment demand relative to modeled amendment-processing capacity."),
			new MetricDefinition("poisonPillRate", "Poison-pill rate", MetricDirection.LOWER_IS_BETTER, "Share of attempted amendment rounds that degrade support or harm."),
			new MetricDefinition("proposerAdvantageReduction", "Proposer advantage reduction", MetricDirection.HIGHER_IS_BETTER, "Amendment movement away from the proposer's original advantage."),
			new MetricDefinition("publicMandateImprovementAfterAmendment", "Mandate gain after amendment", MetricDirection.HIGHER_IS_BETTER, "Public and affected-group support improvement caused by amendment bargaining."),
			new MetricDefinition("affectedHarmReductionByAmendment", "Harm reduction by amendment", MetricDirection.HIGHER_IS_BETTER, "Concentrated-harm reduction caused by amendment or compensation revisions."),
			new MetricDefinition("amendmentRoundUse", "Amendment round use", MetricDirection.DIAGNOSTIC, "Share of available amendment rounds used."),
			new MetricDefinition("implementationDelay", "Implementation delay", MetricDirection.LOWER_IS_BETTER, "Post-enactment delay before a law becomes effectively implemented."),
			new MetricDefinition("implementationCapacity", "Implementation capacity", MetricDirection.HIGHER_IS_BETTER, "Agency or implementation capacity proxy for active laws."),
			new MetricDefinition("implementationFailureRisk", "Implementation failure risk", MetricDirection.LOWER_IS_BETTER, "Risk that enacted law fails through delay, nonenforcement, stay, or underfunding."),
			new MetricDefinition("nonEnforcementRisk", "Nonenforcement risk", MetricDirection.LOWER_IS_BETTER, "Proxy for nonenforcement caused by capacity scarcity or capture."),
			new MetricDefinition("underfundingRisk", "Underfunding risk", MetricDirection.LOWER_IS_BETTER, "Proxy for enacted laws operating below authorized capacity."),
			new MetricDefinition("renewalLobbyPressure", "Renewal lobbying pressure", MetricDirection.LOWER_IS_BETTER, "Organized pressure around law renewal or review."),
			new MetricDefinition("sunsetBeforeImplementationRate", "Sunset before implementation", MetricDirection.LOWER_IS_BETTER, "Temporary laws reaching review before effective implementation.")
	);
