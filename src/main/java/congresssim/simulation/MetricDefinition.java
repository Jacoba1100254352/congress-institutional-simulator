...
public record MetricDefinition(
    ...
    private static final List<MetricDefinition> DEFINITIONS = List.of(
            ...
            new MetricDefinition("publicMandateLegitimacy", "Public-mandate legitimacy", MetricDirection.HIGHER_IS_BETTER, "Support, alignment, legitimacy, and avoidance of weak-mandate enactments."),
            ...
            new MetricDefinition("petitionMandateStrength", "Petition mandate strength", MetricDirection.HIGHER_IS_BETTER, "Public-mandate signal strength among petition-routed bills."),
