...
def write_readme() -> None:
    (PACKAGE_DIR / "README.md").write_text(
        ...
        "The source-pinned executive panels contain 4,021 H.R./S. and 187 H.J.Res./S.J.Res. "
        "presidential decisions, including 47 vetoes and six overrides. "
        "The frozen simulator veto rate is 22.101 times their combined empirical rate, "
        "so the simulator veto mechanism remains an elevated-propensity stress mechanism. "
        "The separate presidential-choice predictor lowers log loss from 0.223369 to 0.026977 "
        "on its complete 118th-Congress test cohort and meets its aggregate calibration gate. "
        "Twelve of the 13 test vetoes occur among only 17 joint resolutions. "
        "This is narrow predictive transport, not causal model validation or broad out-of-regime validation.\n\n"
        "The House route study preserves its 1,445-candidate grid and failed comparison: "
        "three of four conditions pass, but route total variation is 0.110470 against 0.100. "
        "No separate pre-fit protocol commit is established, and the test source distribution "
        "was already known. Route labels do not change the inner voting threshold or amendment rights. "
        "The source audit and linked resolution/vote snapshots record a chamber-attribution caveat "
        "and a separate sensitivity without refitting. Synthetic welfare, public support, harm, "
        "capture, and institutional rankings remain unvalidated.\n\n"
        "Main outputs:\n\n"
