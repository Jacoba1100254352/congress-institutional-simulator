...
SCENARIOS = [
    ...
    ("proportional-committee-assignment-majority", "Majority + proportional committee assignment"),
    ("committee-discharge-target-majority", "Committee discharge-petition target"),
    ("cloture-conference-review", "Cloture, conference, and judicial review"),
    ("constitutional-court-architecture-majority", "Constitutional court architecture"),
    ...
    ("open-rule-calendar-majority", "Open-rule floor calendar + majority"),
    ...
    ("omnibus-bargaining-majority", "Omnibus bargaining + majority"),
    ...
    ("anti-capture-access-majority", "Anti-capture proposal access + majority"),
    ("influence-system-majority", "Campaign-finance influence system"),
    ("risk-routed-majority", "Risk-routed majority legislature"),
    ("portfolio-hybrid-legislature", "Portfolio hybrid legislature"),
    ("expanded-portfolio-hybrid-legislature", "Expanded portfolio hybrid legislature"),
    ("norm-erosion-majority", "Endogenous norm erosion + majority"),
    ("long-horizon-learning-majority", "Long-horizon strategic learning"),
