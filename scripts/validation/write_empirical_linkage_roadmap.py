...
ROADMAP: dict[str, dict[str, str]] = {
    "govinfo bill and action records": {
        "blockingGap": "The complete 116th- 117th- and 118th-Congress H.R./S. censuses are source-backed and classifier-audited, and the compact 108th-118th executive panel covers 4,021 presidential decisions, 21 vetoes, and 6 overrides. The frozen lifecycle backcast and forecast pass 5 of 6 aggregate tolerances while preserving the 118th enactment miss, and the executive diagnostic exposes a 47.266-fold pooled veto-rate mismatch. Joint resolutions, final chamber-vote support, source-specific agenda-control records, and a separately frozen low-event presidential-choice model remain absent.",
        ...
        "minimumViableDataset": "The pinned 116th-118th lifecycle censuses and 108th-118th executive panel plus final chamber-vote support, joint resolutions as a separate measure class, and source-specific referral floor-rule calendar and status-quo-fallback evidence produced under a reviewed common protocol.",
        "acceptanceGate": "Source-specific records test at least one agenda-control mechanism, and a pre-specified low-event presidential-choice estimator and loss are frozen before fitting with at least one whole Congress held out.",
        "futureTarget": "Retain make legislative-executive-action-diagnostic, add H.J.Res./S.J.Res. as a separately reported class, join final House and Senate vote support, and fit only after freezing the low-event estimator, loss, and whole-Congress holdout.",
        "claimUpgradeBoundary": "Supports descriptive census-backed legislative flow, within-Congress held-out checks, two no-refit external-cohort transport checks, and an 11-Congress veto mechanism diagnostic; it does not estimate causal party effects or validate public welfare, representation, implementation outcomes, or presidential-choice mechanisms.",
    },
