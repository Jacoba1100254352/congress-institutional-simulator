...
ROADMAP: dict[str, dict[str, str]] = {
    "govinfo bill and action records": {
        ...
        "acceptanceGate": "Source-specific records test at least one agenda-control mechanism, and the locked presidential-choice design is applied without retuning to another completed whole-Congress cohort with measure-class-specific results reported.",
        "futureTarget": "Preserve the locked estimator and gate; add a future completed-Congress replication and source-specific referral floor-rule calendar and status-quo-fallback evidence.",
        "claimUpgradeBoundary": "Supports descriptive census-backed legislative flow, two no-refit external-cohort lifecycle checks, and one locked predictive presidential-choice transport result; it does not estimate causal party or vote-support effects or validate public welfare, representation, implementation outcomes, or the simulator's presidential-choice mechanism.",
    },
