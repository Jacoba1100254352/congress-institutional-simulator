...
ROADMAP: dict[str, dict[str, str]] = {
    "govinfo bill and action records": {
        "blockingGap": "The complete 116th- 117th- and 118th-Congress H.R./S. censuses are source-backed and classifier-audited. Separate 108th-118th decision panels now cover 4,021 H.R./S. decisions and 187 joint-resolution decisions, while 8,416 chamber rows preserve 1,685 official final roll calls and 6,731 nonrecorded approvals. The frozen lifecycle backcast and forecast pass 5 of 6 aggregate tolerances while preserving the 118th enactment miss. Source-specific agenda-control records and a separately frozen low-event presidential-choice model remain absent.",
        ...
        "futureTarget": "Freeze the low-event estimator, loss, predictor availability rules, missing-roll-call treatment, and whole-Congress holdout; then fit without revising those choices from results.",
        "claimUpgradeBoundary": "Supports descriptive census-backed legislative flow, two no-refit external-cohort transport checks, separately labeled presidential-decision classes, and post-passage final-vote support; it does not estimate causal party or vote-support effects or validate public welfare, representation, implementation outcomes, or presidential-choice mechanisms.",
    },
