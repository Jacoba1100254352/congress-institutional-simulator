...
ROADMAP: dict[str, dict[str, str]] = {
    "govinfo bill and action records": {
        "blockingGap": "The complete 116th- 117th- and 118th-Congress H.R./S. censuses are source-backed and classifier-audited. Separate 108th-118th decision panels cover 4,021 H.R./S. decisions and 187 joint-resolution decisions, while 8,416 chamber rows preserve 1,685 official final roll calls and 6,731 nonrecorded approvals. The frozen lifecycle backcast and forecast pass 5 of 6 aggregate tolerances while preserving the 118th enactment miss. The locked presidential-choice model passes its 118th-Congress log-loss and aggregate-calibration gate, but 12 of 13 test vetoes arise among only 17 joint resolutions. Source-specific House records now support one locked route test, which passes 3 of 4 gates but fails route composition at total variation 0.110470 versus 0.100. Referral-jurisdiction, status-quo-fallback, and another completed whole-Congress presidential-choice replication remain absent.",
        "requiredJoinKeys": "congress,bill_type,bill_number,bill_id,action_date,president,sponsor_party,roll_call_id,source_xml_sha256,actions_sha256",
        "targetSourceFamilies": "Congress.gov bill histories; House and Senate final-passage and veto-override votes; committee and floor-rule records",
        "minimumViableDataset": "The pinned lifecycle censuses, separately labeled bill and joint-resolution decision panels, and final chamber-vote support now in the repository plus source-specific referral floor-rule calendar and status-quo-fallback evidence produced under a reviewed common protocol.",
        "acceptanceGate": "The retained House route-composition failure is not retuned; a separately locked richer mechanism uses referral-jurisdiction and status-quo-fallback evidence; and the locked presidential-choice design is applied unchanged to another completed whole-Congress cohort with measure-class-specific results reported.",
        "futureTarget": "Preserve both locked results; add referral-jurisdiction and status-quo-fallback evidence, a separately locked richer House route mechanism, and a future completed-Congress presidential-choice replication.",
        "claimUpgradeBoundary": "Supports descriptive census-backed legislative flow, two no-refit external-cohort lifecycle checks, one locked predictive presidential-choice transport result, and one retained House route-mechanism failure; it does not estimate causal party or vote-support effects or validate public welfare, representation, implementation outcomes, presidential choice, or House agenda control.",
    },
