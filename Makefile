...
.PHONY: adversarial-replication-a9 robustness-evidence
...
bill-law-lifecycle-corpus: bill-law-lifecycle-next-actions bill-law-evidence-spine court-public-law-direct-review district-public-opinion-survey-item-proxy-review bill-finance-lobbying-local-context-review bill-finance-lobbying-external-search-review bill-finance-lobbying-external-lda-mention-review bill-finance-lobbying-campaign-finance-target-scope-review statutory-lineage-codified-progress statutory-lineage-target-lifecycle-bridge rulemaking-comment-text-review
...
robustness-evidence: adversarial-stress-manifest adversarial-replication-a9
