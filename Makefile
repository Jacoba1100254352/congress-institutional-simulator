...
.PHONY: adversarial-replication-a1-a8 adversarial-replication-a9 robustness-evidence legislative-lifecycle-calibration govinfo-bill-census-check
...
govinfo-bill-census-check: legislative-lifecycle-calibration
	python3 scripts/checks/check_govinfo_bill_census.py
