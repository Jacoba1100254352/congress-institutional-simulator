...
.PHONY: build run campaign campaign-v0 campaign-v1 campaign-v2 campaign-v3 campaign-v4 campaign-v5 campaign-v6 campaign-v7 campaign-v8 campaign-v9 campaign-v10 campaign-v11 campaign-v12 campaign-v13 campaign-v14 campaign-v15 campaign-v16 campaign-v17 campaign-v18 paper paper-clean test clean
...
campaign: build
	java -cp out/main congresssim.Main --campaign v18 --runs 120 --legislators 101 --bills 60 --seed 20260428 --output-dir reports $(ARGS)
...
campaign-v14: build
	java -cp out/main congresssim.Main --campaign v14 --runs 150 --legislators 101 --bills 60 --seed 20260428 --output-dir reports $(ARGS)

campaign-v13: build
	java -cp out/main congresssim.Main --campaign v13 --runs 150 --legislators 101 --bills 60 --seed 20260428 --output-dir reports $(ARGS)

campaign-v12: build
	java -cp out/main congresssim.Main --campaign v12 --runs 150 --legislators 101 --bills 60 --seed 20260428 --output-dir reports $(ARGS)
